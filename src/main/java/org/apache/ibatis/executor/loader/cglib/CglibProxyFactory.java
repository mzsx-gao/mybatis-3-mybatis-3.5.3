...
public class CglibProxyFactory implements ProxyFactory {
    ...
    public CglibProxyFactory() {
        try {
            ...
            throw new IllegalStateException("Cannot enable lazy loading because CGLIB is not available. Add CGLIB to " +
                "your classpath.", e);
        }
    }
    ...
    static Object crateProxy(Class<?> type, Callback callback, List<Class<?>> constructorArgTypes,
        ...
        try {
            ...
            if (LogHolder.log.isDebugEnabled()) {
                LogHolder.log.debug(WRITE_REPLACE_METHOD + " method was found on bean " + type + ", make sure it " +
                    "returns this");
            }
